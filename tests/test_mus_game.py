...
class TestMusGame(unittest.TestCase):
    ...
    def test_calcular_probabilidad_mano_casos_conocidos(self):
        ...
        # RRRA: C(8,3)*C(8,1)/C(40,4) = 56*8/91390
        prob_solomillo_esperada = (56 * 8) / 91390
        prob_solomillo_real = self.mus_game.calcular_probabilidad_mano("RRRA")
        self.assertAlmostEqual(prob_solomillo_real, prob_solomillo_esperada, places=10)
    ...
    def test_calcular_puntos_mano_casos_conocidos(self):
        ...
        puntos_4_reyes = self.mus_game._MusGame__calcular_puntos_mano("RRRR")
        self.assertEqual(puntos_4_reyes, 40)

        # Mano con 4 ases (mínimo puntaje)
        puntos_4_ases = self.mus_game._MusGame__calcular_puntos_mano("AAAA")
        self.assertEqual(puntos_4_ases, 4)

        # Mano mixta conocida
        puntos_mixta = self.mus_game._MusGame__calcular_puntos_mano("RCA7")
    ...
    def test_calcular_pares_casos_conocidos(self):
        ...
        self.assertEqual(self.mus_game._MusGame__calcular_pares("RRRR"), "Duples")
        self.assertEqual(self.mus_game._MusGame__calcular_pares("AAAA"), "Duples")

        # Test Duples (2 pares)
        self.assertEqual(self.mus_game._MusGame__calcular_pares("RRAA"), "Duples")
        self.assertEqual(self.mus_game._MusGame__calcular_pares("CC77"), "Duples")

        # Test Medias (3 iguales)
        self.assertEqual(self.mus_game._MusGame__calcular_pares("RRRA"), "Medias")
        self.assertEqual(self.mus_game._MusGame__calcular_pares("AAA7"), "Medias")

        # Test Par (2 iguales)
        self.assertEqual(self.mus_game._MusGame__calcular_pares("RRA7"), "Par")
        self.assertEqual(self.mus_game._MusGame__calcular_pares("AA76"), "Par")

        # Test Nada
        self.assertEqual(self.mus_game._MusGame__calcular_pares("RCA7"), "Nada")
        self.assertEqual(self.mus_game._MusGame__calcular_pares("7654"), "Nada")
    ...
    def test_comparar_grandes(self):
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('RRCA', 'RRAA'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('RCCA', '76AA'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('RRRA', '76AA'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('RCCA', 'RRAA'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('CCSA', 'RAAA'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('C44A', 'C54A'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('RCCA', 'RACC'), 0)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('RRRR', 'CCCC'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_grandes('CSSA', 'CSS7'), -1)

    def test_comparar_chica(self):
        self.assertEqual(self.mus_game._MusGame__comparar_chica('RRAA', '764A'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_chica('RAAA', '44AA'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_chica('RCA5', 'AA4R'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_chica('AA67', 'AA56'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_chica('A467', 'AA56'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_chica('AA67', 'AA76'), 0)

    def test_comparar_pares(self):
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RR4A', '764A'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RR4A', 'CC4A'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RR4A', '7AAA'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RRRA', '764A'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RR44', 'RR77'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RRR4', 'AA77'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RC44', 'RC77'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('AACC', '6677'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RR54', 'RRS7'), 0)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RRR4', 'RRR7'), 0)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RS44', 'RS77'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_pares('RRCC', 'RRRR'), -1)

    def test_comparar_juego(self):
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRCA', 'RRAA'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRCA', 'RRSA'), 0)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRCA', '777S'), 0)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RC76', 'RSS5'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRCS', 'RRC7'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRCS', 'RR57'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRAA', 'RRA4'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RR55', 'RRCA'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RR55', 'RR54'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRC5', 'RRC4'), 1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('RRCS', 'RRCA'), -1)
        self.assertEqual(self.mus_game._MusGame__comparar_juego('4466', '775A'), 0)

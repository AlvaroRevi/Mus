...
class TestMusGame(unittest.TestCase):
    ...
    def test_generar_manos_tipo_retorno(self):
        ...
        manos = self.mus_game.generar_manos()
    ...
    def test_calcular_puntos_mano_casos_conocidos(self):
        ...
        puntos_4_reyes = self.mus_game.calcular_puntos_mano("RRRR")
        self.assertEqual(puntos_4_reyes, 40)

        # Mano con 4 ases (mínimo puntaje)
        puntos_4_ases = self.mus_game.calcular_puntos_mano("AAAA")
        self.assertEqual(puntos_4_ases, 4)

        # Mano mixta conocida
        puntos_mixta = self.mus_game.calcular_puntos_mano("RCA7")
    ...
    def test_calcular_pares_casos_conocidos(self):
        ...
        self.assertEqual(self.mus_game.calcular_pares("RRRR"), "Duples")
        self.assertEqual(self.mus_game.calcular_pares("AAAA"), "Duples")

        # Test Duples (2 pares)
        self.assertEqual(self.mus_game.calcular_pares("RRAA"), "Duples")
        self.assertEqual(self.mus_game.calcular_pares("CC77"), "Duples")

        # Test Medias (3 iguales)
        self.assertEqual(self.mus_game.calcular_pares("RRRA"), "Medias")
        self.assertEqual(self.mus_game.calcular_pares("AAA7"), "Medias")

        # Test Par (2 iguales)
        self.assertEqual(self.mus_game.calcular_pares("RRA7"), "Par")
        self.assertEqual(self.mus_game.calcular_pares("AA76"), "Par")

        # Test Nada
        self.assertEqual(self.mus_game.calcular_pares("RCA7"), "Nada")
        self.assertEqual(self.mus_game.calcular_pares("7654"), "Nada")
